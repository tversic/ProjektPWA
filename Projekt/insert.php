...
<body>
    ...
    <div id="insertForm">
        <form action="skripta.php" method="post" enctype="multipart/form-data" name="forma">
            ...
            <textarea rows="10" cols="250" name="summary" required="required">Insert short summary:</textarea><br>
            <textarea rows="10" cols="250" name="content" required="required">Insert article content:</textarea><br>
            <label for="pics">Choose picture</label><input type="file" name="fileToUpload" id="fileToUpload" required="required">
            <?php
                ...
                echo 
                "<label for='cat'>Pick category: </label>
                <select name='cat'>";
